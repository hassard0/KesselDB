...
| **SP99 — External sources: HTTPS/TLS** | **done** | HTTPS for external sources via the optional `external-sources-tls` build (rustls client + bundled Mozilla roots, full chain+hostname verification, no bypass; `http://` unchanged, sidecar now optional). Kernel & default build byte-identical; gate **247**, seed-7 green. Design: `docs/superpowers/specs/2026-05-18-external-sources-tls-design.md`. Record: `docs/superpowers/specs/2026-05-18-kesseldb-subproject99-ext-tls.md`. |

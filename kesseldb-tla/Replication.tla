...
(*                                                                          *)
(* ─── TLA+ ACTION ↔ kessel-vsr MAPPING (SP109 T4) ──────────────────────── *)
(*                                                                          *)
(* Each named action in this spec corresponds to a kessel-vsr function or  *)
(* Msg variant. Line numbers are accurate as of commit 6904d7b against     *)
(* crates/kessel-vsr/src/lib.rs (1838 lines). This is "named              *)
(* correspondence", not mechanized refinement — see Honest Disclosure #6  *)
(* above. If kessel-vsr is refactored, re-run:                            *)
(*   grep -n "fn on_request\|fn on_prepare\|fn apply_through\|fn tick …"  *)
...
(*                                                                          *)
(* Per-action block comments inside each action body reference the named  *)
(* function; this table is the single source of truth for line numbers.   *)
(*                                                                          *)
(*   TLA+ action       kessel-vsr counterpart              file:line       *)
(*   ───────────────   ─────────────────────────────────   ──────────────  *)
(*   ClientRequest     Msg::Request / Replica::on_request   lib.rs:449     *)
(*   Prepare(m)        Msg::Prepare / Replica::on_prepare   lib.rs:502     *)
(*   PrepareOk(m)      Msg::PrepareOk / on_prepare_ok       lib.rs:554     *)
(*   Commit            Msg::Commit / on_commit_msg          lib.rs:585     *)
(*                       (quorum check → calls apply_through)              *)
(*   Apply             Replica::apply_through (body)        lib.rs:340     *)
(*   HandleCommit(m)   Msg::Commit / Replica::on_commit_msg lib.rs:585     *)
(*                       (backup commit-pointer advance path)              *)
(*   TimeoutPrimary    Replica::tick (idle-tick branch)     lib.rs:722     *)
(*                       → Replica::start_view_change       lib.rs:614     *)
(*   StartViewChange   Msg::StartViewChange / on_svc        lib.rs:627     *)
(*   DoViewChange      Msg::DoViewChange / maybe_finish_svc lib.rs:640     *)
(*   BecomePrimary     Replica::maybe_finish_view_change    lib.rs:663     *)
(*   StartView(m)      Msg::StartView / on_start_view       lib.rs:698     *)
(*   DropMessage       (test-harness: sim drop_pct)         n/a            *)
(*                                                                          *)
(* ─────────────────────────────────────────────────────────────────────── *)
(*                                                                          *)
...
(*                                                                          *)
(* T4 shipped: see "TLA+ ACTION ↔ kessel-vsr MAPPING" table above for    *)
(* exact lib.rs line-number anchors.                                       *)
(***************************************************************************)
